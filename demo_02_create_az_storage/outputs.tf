...
output "container_sas_url" {
  ...
  value       = "${azurerm_storage_account.this.primary_blob_endpoint}${azurerm_storage_container.sales_data.name}?${data.azurerm_storage_account_blob_container_sas.sales_data_sas.sas}"
  sensitive   = true
}